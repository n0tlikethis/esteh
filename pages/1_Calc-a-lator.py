...
st.markdown(
    "Kalkulator sederhana yang menerima 2 operand & dapat dipilih operatornya lalu dapat menampilkan hasil perhitungannya."
)

operators = {
    0: (lambda x, y: x + y, ":material/add:"),
    1: (lambda x, y: x - y, ":material/remove:"),
    2: (lambda x, y: x * y, ":material/close:"),
    3: (lambda x, y: x / y, ":material/go_to_line:")
}
...
selection = st.segmented_control(
    ...
    format_func=lambda option: operators[option][1],
...
if selection is None:
    ...
    result = operators[selection][0](n1, n2)
